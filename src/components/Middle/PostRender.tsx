...
const PostRender = (props: Props) => {
  ...
  const {
    ...
    queryFn: ({ pageParam = "" }) =>
      AllPost({ take: 5, lastCursor: pageParam, typePost: TypePost.POST }),
    queryKey: ["posts"],
  ...
  return (
    <Card className="p-4 my-6">
      <div className="flex items-center space-x-4">
        <Image
          src={data.author.image ? data.author.image : "/image4.jpg"}
          width={40}
          height={40}
          alt="Image"
      ...
      <div className="p-4 my-2">
        {data.content && (
          <p
            className="prose prose-sm sm:prose focus:outline-none prose-p:loading-0 prose-a:text-red-400 xl:prose-base dark:prose-code:text-white dark:prose-p:text-white dark:prose-h1:text-white dark:prose-h2:text-white dark:prose-h3:text-white dark:prose-strong:text-white dark:prose-italic:text-white "
      ...
      <div className="mt-5 grid grid-cols-2 gap-10">
        <div className="relative">
          ...
          <Image
            ...
            height={40}
            alt="Image"
            className="rounded-full h-[40px] object-cover object-top absolute left-[25px] top-0 shadow shadow-gray-200"
          />
          <Image
            src="/image4.jpg"
            width={40}
            height={40}
            alt="Image"
            className="rounded-full h-[40px] object-cover object-top absolute left-[45px] top-0 shadow shadow-gray-200"
          />
        </div>
