...
const PostCreationDialogue = ({
  ...
  const CreatePost = async () => {
    ...
    if (
      (typePost === TypePost.VIDEO || typePost === TypePost.IMAGE) &&
          ...
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              <Card
                ...
                className="w-full min-h-[300px] max-md:max-h-[300px] max-h-[600px] hover:border-red-500 border border-dashed rounded-md border-gray-700 relative overflow-auto"
              >
                {fileUrls.length > 0 ? (
                    ...
                    {typePost !== TypePost.VIDEO && (
                      <>
                        <label
                          style={{ zIndex: "1000" }}
                          htmlFor="file"
                          className="absolute  bottom-1 right-1 w-10 h-10 rounded-full border-dotted border-[1px] border-black cursor-pointer flex items-center justify-center"
                        >
                          <Plus className="w-6 h-6" />
                          <input
                            accept={
                              typePost === TypePost.IMAGE ? "image/*" : "*"
                            }
                            multiple
                  ...
                  <label
                    htmlFor="file"
                    className="absolute top-0 left-0 bottom-0 right-0 cursor-pointer flex flex-col items-center justify-center"
                  >
                    <UploadCloud className="text-3xl opacity-70" />
                    <span className="block">
                      Click or deag & drop your files
                    </span>
                    ...
                    <input
                      ...
                      multiple={typePost !== TypePost.VIDEO ? true : false}
                      onChange={handleFileChange}
                      type="file"
                      name="file"
                      id="file"
              ...
              {isloading ? (
                ...
                <Button className="my-2 w-full " onClick={CreatePost}>
                  Submit
                </Button>
              )}
            </DialogDescription>
