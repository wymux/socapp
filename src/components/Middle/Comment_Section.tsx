...
const Comment_Section = ({ postId, getComments, setGetComments }: Props) => {
  ...
  const [likeStatus_1, setLikeStatus] = useState<{
          ...
          <div key={index} className="p-2">
            <div className="flex items-center space-x-3">
              <Image
                ...
                src={
                  comment.author.image ? comment.author.image : "/image4.jpg"
                }
                alt="User Image"
              />
